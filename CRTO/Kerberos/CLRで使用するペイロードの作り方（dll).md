Generate x64 SMB Beacon shellcode.
...
5. Click **Generate**
6. Save to _C:\Payloads\smb_x64.xthread.bin_
...
2. Place in the same directory: Checked
   プロジェクト名右クリック-> add -> existing item.. からsmb_x64.xthread.bin選択
3. 追加されたsmb_x64.xthread.binのプロパティでembedded resourceを選択
![[images/Pasted image 20260513214600.png]]
...
ビルド方法
DebugからReleaseに変更しておく
![[../MSSQL/images/Pasted image 20260513214657.png]]
BuildからBuild Solutionsを選択
![[../MSSQL/images/Pasted image 20260513214718.png]]


sql-clrでビルドしたファイルをロードする
```
